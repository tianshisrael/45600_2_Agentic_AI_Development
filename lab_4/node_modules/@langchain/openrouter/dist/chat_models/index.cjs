...
var ChatOpenRouter = class extends _langchain_core_language_models_chat_models.BaseChatModel {
	...
	*/
	...
	constructor(modelOrFields, fieldsArg) {
		...
		this.sessionId = fields.sessionId ?? (0, _langchain_core_utils_env.getEnvironmentVariable)("OPENROUTER_SESSION_ID");
	...
	*/
	...
	withStructuredOutput(outputSchema, config) {
		...
		if (method === "jsonSchema") {
			...
			if (!(0, _langchain_core_utils_types.isInteropZodSchema)(schema) && !(0, _langchain_core_utils_standard_schema.isSerializableSchema)(schema) && "name" in schema) functionName = schema.name;
			llm = this.withConfig({
				tools: [{
					type: "function",
					function: {
		...
		return (0, _langchain_core_language_models_structured_output.assembleStructuredOutputPipeline)(llm, outputParser, includeRaw, "ChatOpenRouterStructuredOutput");
	}
};
//#endregion
